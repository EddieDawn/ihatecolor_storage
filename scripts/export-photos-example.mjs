...
const sourcePath = path.join(outputRoot, "photos", "index.html");
const destinationPath = path.join(projectRoot, "photospage_example.html");
...
html = `<!-- Photo journal standalone review copy. Generated from the Astro build. -->\n${html}`;
