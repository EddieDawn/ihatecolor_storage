...
현재 컬렉션에는 13개 작품이 있으며 다음 경계 사례를 포함한다.
...
기존 `prototype-b/` 이미지는 원본을 수정하지 않고 모크 콘텐츠 디렉터리에 복사해 사용한다. 극단 비율 이미지 2개와 정확한 `1254×1254` 정사각형 이미지 1개는 개발 fixture 용도이며 실제 포트폴리오 콘텐츠가 아니다.
